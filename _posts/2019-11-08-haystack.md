...
## HAYSTACK@HTB {:.text-centered}

![Banner](../../../../assets/img/haystack/Banner.png){:.image-centered}

Haystack is an easy box from hackthebox. Ok let’s start. {:.text-left}
#### Quick Hack:
...
![nmap scan](../../../../assets/img/haystack/nmap.png){:.image-centered}
...
![Base64](../../../../assets/img/haystack/string.png){:.image-centered}
...
![9200 port](../../../../assets/img/haystack/elasticsearch.png){:.image-centered}
...
![gobuster](../../../../assets/img/haystack/gobuster.png){:.image-centered}
...
![key](../../../../assets/img/haystack/clave.png){:.image-centered}
...
![user](../../../../assets/img/haystack/ssh.png){:.image-centered}
...
![shell](../../../../assets/img/haystack/payload.png){:.image-centered}
...
![kibana](../../../../assets/img/haystack/kibana.png){:.image-centered}
...
![config files](../../../../assets/img/haystack/conf.d.png){:.image-centered}
